...
below to obtain and install a B101 license file:
...
To check for updates, simply click the version label located at the bottom right corner of the main window as per :numref:`fig-check-update`.
